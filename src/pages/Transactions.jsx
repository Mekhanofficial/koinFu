...
export default function TransactionPage() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`font-semibold rounded-md relative top-28 p-5 mx-10 hover:shadow-lg transition-all duration-300 border overflow-x-auto ${
            theme === "dark"
        ...
        >
          ...
          <div className="min-w-max">
            <div
              className={`grid grid-cols-7 gap-16 text-sm md:text-base text-center ${
